...
### java.lang.AssertionError: assertion failed: denotation module class Seq$ invalid in run 3. ValidFor: Period(1..5, run = 4)
...
class SolucionesFunc {
  ...
  def reconstruirCadenaTurbo(n: Int, o: Oraculo): Seq[Char] = {
    def generarSubC(k: Int, subCadena: Set[Seq[Char]]): Set[Seq[Char]] = {
      ...
      else generarSubC(k * 2, subCadena.flatMap(s1 => subCadena.map(_ ++ s1).filter(o)))
    }
...
scala.runtime.Scala3RunTime$.assertFailed(Scala3RunTime.scala:8)
	...
	dotty.tools.dotc.core.Types$Type.typeSymbol(Types.scala:495)
	dotty.tools.dotc.core.Types$Type.isRepeatedParam(Types.scala:403)
