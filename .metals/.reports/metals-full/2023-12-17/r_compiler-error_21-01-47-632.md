...
### java.lang.AssertionError: assertion failed: denotation object language invalid in run 4. ValidFor: Period(1..2, run = 5)
...
object ProyectoF{
  ...
  // Agregar la secuencia "act" al trie original
  val trieConAct = d.adicionar(Seq('a'), trie)

  // Imprimir el trie resultante
  println(trieConAct)
